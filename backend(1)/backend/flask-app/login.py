...
uri = "mongodb+srv://amanagrawal:ofSqQM7JfhkQfPPi@fushionnet0.crmusbk.mongodb.net/?retryWrites=true&w=majority"
...
def register():
    ...
    if request.method == 'POST' and 'username' in request.form and 'password' in request.form and 'email' in request.form:
        ...
        try:
            result = user.insert_many(user_doc)
